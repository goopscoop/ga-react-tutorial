...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ToDo = __webpack_require__(399);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(198)('getPrototypeOf', function($getPrototypeOf){
	  return function getPrototypeOf(it){
	    return $getPrototypeOf(toObject(it));
	  };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $              = __webpack_require__(209)
	  ...
	  , toIObject      = __webpack_require__(225)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(209).setDesc
	  , has = __webpack_require__(215)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store  = __webpack_require__(220)('wks')
	  , uid    = __webpack_require__(223)
	  , Symbol = __webpack_require__(200).Symbol;
	module.exports = function(name){
	  return store[name] || (store[name] =
	    Symbol && Symbol[name] || (Symbol || uid)('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(225)
	  , getNames  = __webpack_require__(209).getNames
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Works with __proto__ only. Old v8 can't work with null proto objects.
	/* eslint-disable no-proto */
	var getDesc  = __webpack_require__(209).getDesc
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ToDoList = __webpack_require__(400);

	var _ToDoList2 = _interopRequireDefault(_ToDoList);

	var _AddListItems = __webpack_require__(401);

	var _AddListItems2 = _interopRequireDefault(_AddListItems);
	...
	var ToDo = function (_React$Component) {
	  ...
	  function ToDo() {
	    ...
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(ToDo)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	      list: ['thing1', 'thing2', 'thing3']
	    }, _this.buildList = function () {
	      return _this.state.list.map(function (el, i) {
	        return _react2.default.createElement(
	          'li',
	          { key: i },
	          el
	    ...
	    }, _this.buildToDoListProps = function () {
	      return {
	        list: _this.state.list,
	        buildList: _this.buildList
	      };
	  ...
	  (0, _createClass3.default)(ToDo, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_AddListItems2.default, null),
	        _react2.default.createElement(_ToDoList2.default, this.buildToDoListProps())
	      );
	    }
	  }]);
	  return ToDo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddListItems = function (_React$Component) {
	  (0, _inherits3.default)(AddListItems, _React$Component);

	  function AddListItems() {
	    (0, _classCallCheck3.default)(this, AddListItems);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(AddListItems).apply(this, arguments));
	  }

	  (0, _createClass3.default)(AddListItems, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
